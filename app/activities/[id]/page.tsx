    ...
    const fetchActivity = async () => {
      try {
        ...
        const response = await fetch(
          `/api/activities/public?id=${activityId}&rootUserId=${rootUserId}`
        );
        ...
        if (data.activities && data.activities.length > 0) {
          ...
          console.log('Inside images:', activityData.insideImages);
              ...
              <ul className='breadcrumbs'>
                ...
                <li>
                  ...
                  <span className='text-breadcrumb'>
                    {activity.insideTitle || activity.title || activity.name}
                  </span>
                </li>
              </ul>
            </div>
                  ...
                  <div className='swiper-container swiper-group-1'>
                    <Swiper {...swiperGroup1}>
                      ...
                      activity.insideImages.length > 0 ? (
                        // Use insideImages if available
                        activity.insideImages
                          .sort((a, b) => (a.order || 0) - (b.order || 0))
                          .filter(image => image.url && image.url.trim() !== '')
                          .map((image, index) => (
                            <SwiperSlide key={index}>
                              <div className='box-banner-tour-4'>
                                <img
                                  src={image.url}
                                  ...
                                  onError={e => {
                                    ...
                                    e.currentTarget.src =
                                      '/assets/imgs/page/tour-detail/banner-detail-2.png';
                                  }}
                                />
                              </div>
                            </SwiperSlide>
                        ...
                        // Fallback to single images if no insideImages
                        <>
                          <SwiperSlide>
                            <div className='box-banner-tour-4'>
                              <img
                                src={
                                  activity.insideImageUrl ||
                                  activity.imageUrl ||
                                  '/assets/imgs/page/tour-detail/banner-detail-2.png'
                                }
                                alt={
                                  activity.insideImageAlt ||
                                  activity.altText ||
                                  activity.name
                                }
                                onError={e => {
                          ...
                          {activity.insideImageUrl && activity.imageUrl && (
                            <SwiperSlide>
                              <div className='box-banner-tour-4'>
                                <img
                          ...
                          {!activity.insideImageUrl && !activity.imageUrl && (
                            <SwiperSlide>
                              <div className='box-banner-tour-4 flex items-center justify-center bg-gray-200'>
                ...
                <div className='tour-header tour-header-on-top'>
                  ...
                  <div className='tour-metas'>
                    <div className='tour-meta-left'>
                      ...
                      {/* <Link
                        className='text-md-medium color-white mr-30'
                        href='#'
                      >
                        Show on map
                      </Link> */}
            ...
            <div className='container'>
              <div className='row'>
                <div className='col-lg-8'>
                  ...
                  <div className='box-collapse-expand pt-30'>
                        ...
                        <div className='card card-body'>
                          <div
                            ...
                            dangerouslySetInnerHTML={{
                              __html:
                                activity.insideDescription ||
                                activity.description ||
                                'Elevate your experience with this amazing activity. Discover new perspectives and create unforgettable memories.',
                            }}
                          />
                        </div>
                      </div>
                        ...
                        <div className='card card-body'>
                          ...
                          activity.highlights.length > 0 ? (
                            ...
                            <div
                              ...
                              dangerouslySetInnerHTML={{
                                __html:
                                  activity.insideShortDescription ||
                                  'Experience the highlights of this amazing activity. From breathtaking views to unforgettable moments, every detail is crafted for your enjoyment.',
                              }}
                            />
                          )}
                        </div>
                        ...
                        <div className='card card-body'>
                          <div className='row'>
                            <div className='col-lg-6'>
                              ...
                              <ul>
                                <li>Admission to {activity.name}</li>
                            ...
                            <div className='col-lg-6'>
                              ...
                              <ul>
                                ...
                                <li>Personal expenses and meals</li>
                                <li>Optional upgrades and add-ons</li>
                      ...
                      >
                        <div className='card card-body'>
                          <div
                            ...
                            dangerouslySetInnerHTML={{
                              __html: `
                                <p>Your ${activity.name} experience is designed to provide you with the perfect balance of adventure and comfort:</p>
                                <ul class="list-number">
                                  <li><strong>Preparation: </strong><span>15 minutes for safety briefing and equipment setup.</span></li>
                                  <li><strong>Main Activity: </strong><span>Enjoy the core experience for 2-3 hours.</span></li>
                                  <li><strong>Break Time: </strong><span>Take a refreshing break for 30 minutes.</span></li>
                                  <li><strong>Wrap-up: </strong><span>15 minutes for debriefing and feedback.</span></li>
                                </ul>
                                <p>Total duration: Approximately 3-4 hours including preparation and breaks.</p>
                              `,
                            }}
                          />
                        </div>
                ...
                <div className='col-lg-4 pt-30'>
                  <div className='booking-form'>
                    <div className='head-booking-form'>
                      ...
                      <div className='activity-price-info mt-3'>
                        {/* <h5 className='text-lg-bold neutral-1000'>
                          ${activity.highlight ? '299' : '199'}
                        </h5> */}
                        {/* <p className='text-sm-medium neutral-500'>per person</p>
                        {activity.highlight && (
