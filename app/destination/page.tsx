                    ...
                    <div className='p-6'>
                      ...
                      <div className='flex justify-between items-center mt-4 pt-4 border-t border-gray-100'>
                        <Link
                          ...
                          className='flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 text-center mr-3'
                          style={{
                            background:
                              'linear-gradient(90deg, #64a25f 0%, #059669 100%)',
                          }}
                        >
                          View Details
                        </Link>
