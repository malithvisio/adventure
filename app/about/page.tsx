    ...
    <>
      <Layout headerStyle={1} footerStyle={2}>
        <div>
            ...
            <div className='container'>
              <div className='row align-items-end'>
                <div className='col-lg-7 wow fadeInUp'>
                  {' '}
                  {/* <span className="btn btn-brand-primary">
                    {" "}
                    <img
                      className="mr-10"
                  ...
                  {/* <p className='text-xl-medium neutral-500'>
                    At Adventure LK, we provide reliable transportation services
                    across Sri Lanka, tailored to your needs.
                  </p> */}
                </div>
                <div className='col-lg-5'>
                  <div className='box-icon-flight'>
                    ...
                    <h6 className='neutral-1000'>
                      Choose Adventure LK for reliable, 24/7 transportation
                      {/* anywhere in Sri Lanka. With fast service, well-maintained
                      vehicles, and professional drivers, we guarantee safe and
                      comfortable rides every time. From quick trips to long
                      tours, we're here for you! */}
                    </h6>
                  </div>
                </div>
              </div>
          ...
          <Team />
          <section className='section-box box-why-book-travila-5 nature-green-background'>
            <div className='container'>
                ...
                <div className='col-lg-6 mb-30'>
                  {/* <span className="btn btn-brand-secondary background-0 wow fadeInUp">
                    ...
                    <img
                      ...
                      alt="Travile"
                    />
                    Why book atAdventure LK ?
                  </span> */}
                  <h2 className='mt-15 mb-15 neutral-1000 wow fadeInUp'>
                    Embracing Adventure Since 2020
                  </h2>
                  ...
                  <div className='list-numbers wow fadeInUp'>
                    ...
                    <div className='item-number'>
                      <h3 className='neutral-1000'>150+</h3>
                      <p className='text-lg-bold neutral-500'>
                        Tours Completed
                      </p>
                    </div>
                    <div className='item-number'>
                      <h3 className='neutral-1000'>7+</h3>
                      <p className='text-lg-bold neutral-500'>
                        Years Experience
                      </p>
                    </div>
                    <div className='item-number'>
                      <h3 className='neutral-1000'>1000+</h3>
                      <p className='text-lg-bold neutral-500'>
                        Happy Customers
                      </p>
                    </div>
                    ...
                    <div className='col-lg-6 col-sm-6'>
                      <div className='card-why card-why-2 background-2 wow fadeInUp'>
                        ...
                        <div className='card-info'>
                          ...
                          <p className='text-lg-medium neutral-500'>
                            4.8 stars from 1000+ Trustpilot reviews.
                          </p>
                        </div>
                      </div>
                      <div className='card-why card-why-2 background-4 wow fadeInUp'>
                        ...
                        <div className='card-info'>
                          ...
                          <p className='text-lg-medium neutral-500'>
                            Travel Safety with Guides and Drivers{' '}
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          {/* <section className="section-box box-meet background-body">
            <div className="container">
              <div className="row align-items-end">
                <div className="col-lg-6 mb-30 wow fadeInUp">
                  ...
                  <p className="text-xl-medium neutral-500">
                    ...
                    making your relaxing journey seamless and successful
                  </p>
                </div>
                      ...
                      <div className="card-info">
                        ...
                        <div className="card-team-bottom">
                          <div className="card-socials">
                            {" "}
                            <Link
                              className="link-social background-100"
                              href="#"
                            >
                              <svg
                                width={15}
                ...
                <div className="col-lg-7 mb-30">
                  <div className="box-left-payment">
                    ...
                    <h2 className="title-why mb-25 mt-10 neutral-1000">
                      Experience Serendipity in Sri Lanka
                    </h2>
                    <p className="text-xl-medium neutral-500 mb-35">
                      Uncover the charm of Sri Lanka's golden beaches, lush tea
                      plantations, and ancient wonders—responsibly. Support
                      eco-friendly travel, local communities, and wildlife
                      conservation while exploring the island's vibrant culture
            ...
            <div className="container">
              <div className="row align-items-end">
                <div className="col-md-6 mb-30 wow fadeInLeft">
                  <h2 className="neutral-1000">Tour Guides</h2>
                  <p className="text-xl-medium neutral-500">
