...
// Define the interface for the Booking model with static methods
interface IBookingModel extends Model<IBooking> {
  findByCompany(companyId: string): Promise<IBooking[]>;
  findByRootUser(rootUserId: string): Promise<IBooking[]>;
  findByUser(userId: string, companyId: string): Promise<IBooking[]>;
  findByStatusAndCompany(
    status: string,
    companyId: string
  ): Promise<IBooking[]>;
  findByStatusAndRootUser(
    status: string,
    rootUserId: string
  ): Promise<IBooking[]>;
  findByStatusAndUser(
  ...
  findByPaymentStatusAndCompany(
    paymentStatus: string,
    companyId: string
  ): Promise<IBooking[]>;
  findByPaymentStatusAndRootUser(
    paymentStatus: string,
    rootUserId: string
  ): Promise<IBooking[]>;
  findByPaymentStatusAndUser(
    paymentStatus: string,
    userId: string,
    companyId: string
  ): Promise<IBooking[]>;
  countByCompany(companyId: string): Promise<number>;
  countByRootUser(rootUserId: string): Promise<number>;
  countByUser(userId: string, companyId: string): Promise<number>;
  getStatsByCompany(companyId: string): Promise<any>;
  getStatsByRootUser(rootUserId: string): Promise<any>;
  getStatsByUser(userId: string, companyId: string): Promise<any>;
}
