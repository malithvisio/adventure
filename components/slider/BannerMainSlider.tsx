      ...
      >
        <div className='banner-slide'>
          <div
            ...
            style={{
              backgroundImage:
                'url("/assets/imgs/slider/landing-2048x1365.jpeg")',
        ...
        <div className='banner-slide'>
          <div
            ...
            style={{
              backgroundImage:
                'url("/assets/imgs/slider/Hiking-Trails-for-the-Ultimate-Mountaineer-1920.jpg")',
              backgroundSize: 'cover',
              backgroundPosition: 'center',
            }}
          >
        ...
        <div className='banner-slide'>
          <div
            ...
            style={{
              backgroundImage:
                'url("/assets/imgs/slider/White-Water-Rafting-and-Canoeing-gallery-pop-up-(3)-min.jpg")',
              backgroundSize: 'cover',
              backgroundPosition: 'center',
            }}
          >
        ...
        <div className='banner-slide'>
          <div
            ...
            style={{
              backgroundImage:
                'url("/assets/imgs/slider/Teadrop-Hotels-Nine-Skies-Flying-Ravana-Adventure-Park-1200x630-1.jpg")',
              backgroundSize: 'cover',
              backgroundPosition: 'center',
            }}
          >
