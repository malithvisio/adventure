            ...
            >
              ...
              >
                ...
                <p className='text-md neutral-400 icon-email'>
                  <a
                    href='mailto:jayanthachanu@gmail.com '
              ...
              >
                <form
                  ...
                  onSubmit={e => {
                    e.preventDefault();
                    if (askEmail.trim()) {
                      const waUrl = `https://wa.me/94766867707?text=${encodeURIComponent(
          ...
          <div className='row mt-5'>
              ...
              <div className='block-socials-footer'>
                ...
                <div className='box-socials-footer'>
                  <Link
                    ...
                    target='_blank'
                    href='https://www.instagram.com/godare__?igsh=OXphdGFrMzNsMzl1&utm_source=qr'
                  >
                    <svg
                      width={20}
                      height={20}
                  ...
                  <Link
                    ...
                    href='https://www.facebook.com/profile.php?id=61569272104719&mibextid=wwXIfr&mibextid=wwXIfr'
                    target='_blank'
                  ...
                  <Link
                    ...
                    href='https://www.tiktok.com/@godare__?_t=ZS-8xK8s3DHbOr&_r=1'
                    target='_blank'
                    rel='noopener noreferrer'
                  >
                    <svg
            ...
            <div className='col-md-4 mb-30'>
              <div className='box-need-help'>
                ...
                <br />
                <a className='heading-6 phone-support' href='tel:94766867707'>
                  +94 766 86 77 07
                </a>
              </div>
            </div>
