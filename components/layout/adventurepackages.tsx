...
export default function AdventurePackages() {
  ...
  if (categoriesData?.categories && packagesData?.packages) {
    ...
    console.log('=== CATEGORY PACKAGES DEBUG ===');
    console.log(
      'Categories:',
    ...
    console.log(
      'Packages:',
      packages.map(p => ({ id: p.id, title: p.title, category: p.category }))
    );
    ...
    categories.forEach(category => {
      ...
      console.log(
        `Category "${category.name}": ${categoryPackages.length} packages`
      );
    ...
    console.log('Categories with packages:', categoriesWithPackages.length);
  }
            ...
            <div className='row align-items-end'>
              <div className='col-12 mb-3 text-center'>
                <div className='text-center '>
                  <h2 className='text-3xl md:text-4xl font-bold text-gray-900 mb-2 mt-30'>
                      ...
                      <SwiperSlide key={index}>
                        ...
                        >
                          <div className='card-image'>
                            <Link
                              className='label'
                              href={generateTourDetailUrl(tour)}
                            >
                              Top Rated
                            </Link>
                            <Link
